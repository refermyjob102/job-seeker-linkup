...
const Landing = () => {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="bg-gradient-to-br from-primary/90 via-primary to-primary-foreground/20 text-white py-20 md:py-28 px-4">
      ...
      <section className="py-20 px-4 bg-background relative">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold">Trusted by thousands of professionals</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 bg-card rounded-xl shadow-sm border border-border/40 hover:shadow-md transition-all">
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            <div className="flex flex-col items-center text-center group">
              <div className="w-16 h-16 bg-primary rounded-full flex items-center justify-center text-white text-xl font-bold mb-6 shadow-lg group-hover:scale-110 transition-transform">1</div>
            ...
            <div className="flex flex-col items-center text-center group">
              <div className="w-16 h-16 bg-primary rounded-full flex items-center justify-center text-white text-xl font-bold mb-6 shadow-lg group-hover:scale-110 transition-transform">2</div>
            ...
            <div className="flex flex-col items-center text-center group">
              <div className="w-16 h-16 bg-primary rounded-full flex items-center justify-center text-white text-xl font-bold mb-6 shadow-lg group-hover:scale-110 transition-transform">3</div>
      ...
      <footer className="bg-background py-16 px-4 border-t">
        <div className="container mx-auto max-w-6xl">
