...
const MemberProfile = () => {
  ...
  const [user, setUser] = useState<typeof userData[0] | null>(null);
  ...
  return (
    <div className="space-y-6">
      <Link to={isReferrer ? `/app/companies/${user.company?.toLowerCase()}` : "/app/members"} className="inline-flex items-center text-sm text-muted-foreground hover:text-foreground mb-4">
        <ArrowLeft className="mr-1 h-4 w-4" />
        Back to {isReferrer ? user.company : "Members"}
      </Link>
        ...
        <div className="lg:col-span-1 space-y-6">
          <Card>
            <CardHeader className="flex flex-col items-center">
              ...
              <CardDescription>{user.jobTitle || "Job Seeker"}</CardDescription>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex justify-between">
                {user.social?.linkedin && (
                  <a href={user.social.linkedin} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground">
                ...
                {user.social?.github && (
                  <a href={user.social.github} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground">
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                {user.social?.twitter && (
                  <a href={user.social.twitter} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground">
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
